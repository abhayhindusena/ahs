...
## 🌐 Official Contacts & Channels
- **Official Email:** [ahsrmdas@gmail.com](mailto:ahsrmdas@gmail.com)
...
- `index.html`: Complete, self-contained, responsive bilingual (English / తెలుగు) web application in the dark royal gold & obsidian theme.
- `assets/`:
  - `founder.jpg`: Official portrait of Shri Radha Manohar Das in Tirupati.
  - `hero-desktop.png`: Custom desktop hero artwork.
  - `hero-mobile.png`: Custom mobile hero artwork.

---
© 2026 Abhay Hindu Sena. All Rights Reserved.
